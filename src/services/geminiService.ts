  ...
  const salons: Salon[] = [
    {
      ...
      description:
        "Looks Salon is a premium beauty salon for men and women who desire to look the best every day.",
      imageUrl:
      ...
      services: [
        {
          id: "l1",
          name: "Director Cut (Men)",
          duration: "45 min",
          price: 800,
        },
        {
          id: "l2",
          name: "Director Cut (Women)",
          duration: "60 min",
          price: 1500,
        },
    ...
    },
    {
      ...
      description:
        "TONI&GUY is a multi-award winning hairdressing brand with more than 55 years of experience in education.",
      imageUrl:
        "https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?q=80&w=2574&auto=format&fit=crop",
      stylists: ["Sandeep Singh", "Meera Nair", "John Doe"],
      services: [
        {
          id: "t1",
          name: "Creative Cut & Finish",
          duration: "60 min",
          price: 1800,
        },
        {
          id: "t2",
          name: "Toni&Guy Signature Color",
          duration: "150 min",
          price: 5500,
        },
        {
    ...
    },
    {
      ...
      description:
        "Jawed Habib Hair and Beauty Ltd is one of the leading hair and beauty salon chains in India.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "An oasis of luxury and relaxation. The Mayfair Salon offers exclusive environment for elite grooming.",
      imageUrl:
